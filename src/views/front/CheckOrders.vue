<template>
    <div>
        ...
        <div class='container' id='orders_check'>
            ...
            <div class='gocheck'>
                <button class='btn-check' @click.prevent='confirmCart'><i></i>{{ $t("Checkorder.next_btn") }}</button>
                <button class='btn-check' @click.prevent="$router.push('/productlist')"><i>{{ $t("Checkorder.back_btn") }}</i></button>
            </div>
            <div class="declare">
