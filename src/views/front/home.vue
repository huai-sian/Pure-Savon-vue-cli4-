            ...
            <div class='carousel slide carousel-fade' data-ride='carousel' data-pause="false">
                <div class='carousel-inner'>
                    <div class='carousel-item active'>
                        <img src='../../assets/images/thanos-pal-v_Cc1qxKuBs-unsplash.jpg' alt="">
                        <div class='slide-box'></div>
                            <h1>{{ $t("Carousel.slogan1") }}·</h1>
                            <h3>{{ $t("Carousel.detail1") }}
                            <button @click.prevent='$router.push("/productlist")'>{{ $t("Carousel.goshopping") }}</button>
                            </h3>
                    </div>
        ...
        <section id='hotSales'>
            <div class="containerfixed d-flex aiCenter jcCenter flexDirection">
                ...
                <div class='sec d-flex'>
                    <div class='secImg'><img src="../../assets/images/paul-gaudriault-QeIUZMA2mdU-unsplash.jpg" alt=""></div>
                ...
                <div class='sec d-flex'>
                    <div class='secImg'><img src="../../assets/images/paul-gaudriault-TVxI-vkmTLI-unsplash.jpg" alt=""></div>
                    <div class='secContent'>
